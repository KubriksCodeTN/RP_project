...
/**
 * @brief this functions should speed up the algorithm by using angle symmetry 
 * but idk if we'll have time to implement it
constexpr double range_symm([[maybe_unused]] double theta){
    return .0;
}
 */
